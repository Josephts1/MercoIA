...
**MercoIA** es el módulo de clasificación de enfermedades del proyecto **MercoIA**, desarrollado en el marco del *Proyecto de Investigación — Convenio 268-2025*. Utiliza técnicas de visión artificial y aprendizaje profundo para ayudar a agricultores de la región de **Santander (Colombia)** a identificar enfermedades en cultivos de **piña, mora y banano**, únicamente a partir de fotos tomadas con su propio celular.
